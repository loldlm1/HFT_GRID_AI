# Copy de Producto - Candle Structure Filter
...
## Bloque Corto
`Agrega un filtro de calidad por estructura de velas antes de entrar al mercado para reducir senales de baja calidad.`
