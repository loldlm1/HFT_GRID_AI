# Copy de Producto - Structure Compound Context: Breakout Ready
...
## Bloque Corto
`Activa logica compound para escenarios de ruptura y entradas cuando el precio esta listo para salir de rango.`
