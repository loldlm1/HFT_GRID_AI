# Copy de Producto - Grid Strategy Settings
...
## Bloque Corto
`Desbloquea controles avanzados de profundidad y separacion de grid para ajustar mejor el balance riesgo/beneficio.`
