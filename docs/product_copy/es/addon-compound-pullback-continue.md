# Copy de Producto - Structure Compound Context: Pullback Continue
...
## Bloque Corto
`Activa logica compound de continuation tras retroceso para reingresar en la direccion principal.`
