# Addon Product Copy - Structure Compound Context: Volatility Trap
...
## Short Copy Block
`Enable volatility-trap compound logic to handle unstable movement with more defensive context behavior.`
