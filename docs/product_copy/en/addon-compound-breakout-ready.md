# Addon Product Copy - Structure Compound Context: Breakout Ready
...
## Short Copy Block
`Enable breakout-ready compound logic to target moments when price is prepared to move outside a range.`
