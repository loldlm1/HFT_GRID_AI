# Addon Product Copy - Grid Strategy Settings
...
## Short Copy Block
`Unlock advanced grid depth and spacing controls for users who need custom risk/reward shaping beyond base defaults.`
