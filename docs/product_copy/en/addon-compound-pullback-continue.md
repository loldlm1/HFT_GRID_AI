# Addon Product Copy - Structure Compound Context: Pullback Continue
...
## Short Copy Block
`Enable pullback-continuation compound logic to rejoin directional moves after temporary retracements.`
