...
input int                    Pandora_Box_Broker_Retry_Attempts = 3;
input int                    Pandora_Box_Broker_Retry_Min_Seconds = 1;
input int                    Pandora_Box_Broker_Retry_Window_Seconds = 5;
input double                 Pandora_Box_Broker_Retry_Max_Drift_Points = 50.0;
...
input double                   Pandora_Box_Offset_Points    = 1.0;
