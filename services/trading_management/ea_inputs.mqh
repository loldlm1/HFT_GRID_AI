...
int    Pandora_Box_Broker_Retry_Attempts = 3;
int    Pandora_Box_Broker_Retry_Min_Seconds = 1;
int    Pandora_Box_Broker_Retry_Window_Seconds = 5;
double Pandora_Box_Broker_Retry_Max_Drift_Symbol_Factor = 1.0;
