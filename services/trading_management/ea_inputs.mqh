...
input group  "+= BULLISH LIFE EA V1.0 =+";
...
input BaseIndicatorPeriodTypes  Base_Indicator_Period_Type  = BASE_PERIOD_5;
...
input IndicatorShiftTypes       Strategy_Channel_Indicator_Shift = INDICATOR_SHIFT_0;
 ...
 StrategyGlobalStochEntryModes Strategy_Global_Stoch_Entry_Mode = STOCH_ENTRY_OVER_BS;
 SignalConcurrencyModes    Signal_Concurrency_Mode     = SINGLE_RUNNING_SIGNAL;
 int                       Alligator_Jaws_Period       = 34;

//input group "+= Strategy Base Context =+";
 StrategyTrendModes          Strategy_Base_Trend_Mode          = TREND_ALLIGATOR_JAWS;
 StrategyEntryChannelModes Strategy_Base_Entry_Evaluation   = ENTRY_EVAL_GLOBAL;
...
input double                Grid_Points_Range_Setup      = 1000.0;
...
input double                Grid_Points_TP               = 0.0;
 ...
 double                Grid_Positions_Stops_Percent = 0.0;
...
input double                 Grid_Trailing_TP_Percent     = 0.0;
