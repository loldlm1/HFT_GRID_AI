...
enum PivotTrialEntryPolicies
{
  PIVOT_TRIAL_ENTRY_STRUCTURAL  = 0,
  PIVOT_TRIAL_ENTRY_MIDPOINT_50 = 1
};

enum PivotTrialRoles
{
  PIVOT_TRIAL_ROLE_H1            = 0,
...
enum PivotTrialEligibilityStatuses
{
  ...
  PIVOT_TRIAL_ELIGIBILITY_NOT_TRIGGERED       = 1,
...
enum PivotTrialFirstTouchOutcomes
{
  ...
  PIVOT_TRIAL_FIRST_TOUCH_NOT_TRIGGERED = 3,
  PIVOT_TRIAL_FIRST_TOUCH_INELIGIBLE    = 4,
  PIVOT_TRIAL_FIRST_TOUCH_CENSORED      = 5
};
