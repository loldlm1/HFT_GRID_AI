...
enum TrendStructureCompoundModes
{
  ...
  COMPOUND_MODE_BREAKOUT_FOLLOW_BUY     = 9,
  COMPOUND_MODE_BREAKOUT_FOLLOW_SELL    = 10,

  // Uncommon / defensive
  COMPOUND_MODE_CHOP_GUARD              = 11,
  COMPOUND_MODE_VOLATILITY_TRAP         = 12,
  COMPOUND_MODE_COMPRESSION_WAIT        = 13
};
