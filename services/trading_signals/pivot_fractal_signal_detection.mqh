...
void FinalizeActivePivotWindowsForExport(const string terminal_status)
{
  ...
  PivotV9RecordWindow(g_pivot_fractal_window,
                      TimeCurrent(),
                      terminal_status);
  g_pivot_window_terminal_exported_open =
    g_pivot_fractal_window.active_bar_open;
