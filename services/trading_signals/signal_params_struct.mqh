...
struct SignalParams
{
  ...
  datetime pandora_theoretical_entry_time;
  datetime pandora_source_entry_time;
  datetime pandora_broker_simulated_entry_time;
  datetime pandora_broker_fill_time;
  ...
  bool     pandora_xboost_enabled;
  bool     pandora_xboost_local_only;
  bool     pandora_xboost_broker_selected;
  int      pandora_xboost_depth;
  int      pandora_xboost_broker_trade_index;
  SignalTypes pandora_xboost_root_side;
  PandoraXBoostCloseEvents pandora_xboost_parent_event;
  PandoraXBoostCloseEvents pandora_xboost_close_event;
  ...
  SignalParams()
  {
    ...
    pandora_theoretical_entry_time = 0;
    pandora_source_entry_time = 0;
    pandora_broker_simulated_entry_time = 0;
    pandora_broker_fill_time = 0;
    ...
    pandora_marker_id          = "";
    pandora_xboost_enabled     = false;
    pandora_xboost_local_only  = false;
    pandora_xboost_broker_selected = false;
    pandora_xboost_depth       = 0;
    pandora_xboost_broker_trade_index = 0;
    pandora_xboost_root_side   = NO_SIGNAL;
    pandora_xboost_parent_event = PANDORA_XBOOST_EVENT_NONE;
    pandora_xboost_close_event = PANDORA_XBOOST_EVENT_NONE;
  ...
  SignalParams(const SignalParams &signal_params)
  {
    ...
    pandora_theoretical_entry_time = signal_params.pandora_theoretical_entry_time;
    pandora_source_entry_time     = signal_params.pandora_source_entry_time;
    pandora_broker_simulated_entry_time = signal_params.pandora_broker_simulated_entry_time;
    pandora_broker_fill_time      = signal_params.pandora_broker_fill_time;
    ...
    pandora_xboost_enabled       = signal_params.pandora_xboost_enabled;
    pandora_xboost_local_only    = signal_params.pandora_xboost_local_only;
    pandora_xboost_broker_selected = signal_params.pandora_xboost_broker_selected;
    pandora_xboost_depth         = signal_params.pandora_xboost_depth;
    pandora_xboost_broker_trade_index = signal_params.pandora_xboost_broker_trade_index;
    pandora_xboost_root_side     = signal_params.pandora_xboost_root_side;
    pandora_xboost_parent_event  = signal_params.pandora_xboost_parent_event;
    pandora_xboost_close_event   = signal_params.pandora_xboost_close_event;
