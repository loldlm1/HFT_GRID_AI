...
struct SignalParams
{
  ...
  SignalParams(const SignalParams &signal_params)
  {
    ...
    extremum_cycle_id            = signal_params.extremum_cycle_id;
    extremum_revision_id         = signal_params.extremum_revision_id;
    extremum_attempt_id          = signal_params.extremum_attempt_id;
    extremum_revision_index      = signal_params.extremum_revision_index;
    cycle_attempt_index          = signal_params.cycle_attempt_index;
    revision_attempt_index       = signal_params.revision_attempt_index;
    candidate_depth_percent      = signal_params.candidate_depth_percent;
    reference_range_points       = signal_params.reference_range_points;
    distance_from_first_revision_points = signal_params.distance_from_first_revision_points;
    distance_from_previous_revision_points = signal_params.distance_from_previous_revision_points;
    depth_delta_from_previous_percent = signal_params.depth_delta_from_previous_percent;
    bars_since_cycle_start       = signal_params.bars_since_cycle_start;
    ...
    deterministic_stats_admission_seen_keys = signal_params.deterministic_stats_admission_seen_keys;
