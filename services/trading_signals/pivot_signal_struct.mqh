...
const int PIVOT_ROUTE_MAX_MILESTONES = 3;
...
struct PivotSignal
{
  ...
  void CopyFrom(const PivotSignal &other)
  {
    ...
    previous_m1_bar_open = other.previous_m1_bar_open;
    previous_m1_close_boundary = other.previous_m1_close_boundary;
    previous_m1_bid_close = other.previous_m1_bid_close;
    trigger_bid = other.trigger_bid;
    trigger_ask = other.trigger_ask;
    trigger_spread_points = other.trigger_spread_points;
    touch_distance = other.touch_distance;
