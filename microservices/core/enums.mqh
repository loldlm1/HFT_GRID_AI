...
enum PandoraLocalEntryStatuses
{
  ...
  PANDORA_LOCAL_ENTRY_PENDING   = 3
};

enum PandoraExecutionSourceStatuses
{
  PANDORA_EXECUTION_SOURCE_NONE             = 0,
  PANDORA_EXECUTION_SOURCE_THEORETICAL      = 1,
  PANDORA_EXECUTION_SOURCE_BROKER_SIMULATED = 2,
  PANDORA_EXECUTION_SOURCE_BROKER_FILLED    = 3
};
...
enum PandoraXBoostModes
{
  PANDORA_XBOOST_DISABLED  = 0,
  PANDORA_XBOOST_TRAINING  = 1,
  PANDORA_XBOOST_INFERENCE = 2
};

enum PandoraXBoostCloseEvents
{
  PANDORA_XBOOST_EVENT_NONE        = 0,
  PANDORA_XBOOST_EVENT_ROOTL       = 1,
  PANDORA_XBOOST_EVENT_ROOTS       = 2,
  PANDORA_XBOOST_EVENT_SLL1        = 3,
  PANDORA_XBOOST_EVENT_SLS1        = 4,
  PANDORA_XBOOST_EVENT_TPL         = 5,
  PANDORA_XBOOST_EVENT_TPS         = 6,
  PANDORA_XBOOST_EVENT_TBE         = 7,
  PANDORA_XBOOST_EVENT_TBEL        = 8,
  PANDORA_XBOOST_EVENT_TBES        = 9,
  PANDORA_XBOOST_EVENT_TTPL        = 10,
  PANDORA_XBOOST_EVENT_TTPS        = 11,
  PANDORA_XBOOST_EVENT_FORCE_CLOSE = 12
};

enum PandoraXBoostCandidateStatuses
{
  PANDORA_XBOOST_CANDIDATE_NONE  = 0,
  PANDORA_XBOOST_CANDIDATE_WAIT  = 1,
  PANDORA_XBOOST_CANDIDATE_WATCH = 2,
  PANDORA_XBOOST_CANDIDATE_READY = 3,
  PANDORA_XBOOST_CANDIDATE_BLOCK = 4
};
